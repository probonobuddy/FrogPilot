...
GAS_BRAKE_TOGGLES = (
  ...
  ToggleDefinition(
    ...
    car_params=["openpilot_longitudinal"],
    description=("<b>Automatically slow down for upcoming curves</b> using the model's predicted road curvature and your manual settings."),
  ...
  ToggleDefinition(
    ...
    param="CurveSensitivity",
    description=("<b>Adjust how strongly predicted curvature affects the requested speed.</b> Higher values slow sooner and more for curves; lower values respond later and allow faster turns."),
    max_value=150,
    min_value=50,
  ...
  ToggleDefinition(
    ...
    param="TurnAggressiveness",
    description=("<b>Set the target lateral acceleration for curves.</b> Higher values allow faster turns; lower values produce gentler turns. 100% uses the historical 2.0 m/s² base target."),
    max_value=150,
    min_value=50,
    parent_param="CurveSpeedController",
    step=1,
