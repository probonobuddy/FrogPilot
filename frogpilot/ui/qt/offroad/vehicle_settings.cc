...
FrogPilotVehiclesPanel::FrogPilotVehiclesPanel(FrogPilotSettingsWindow *parent, bool forceOpen) : FrogPilotListWidget(parent), parent(parent) {
  ...
  std::vector<std::tuple<QString, QString, QString, QString>> vehicleToggles {
    ...
    {"ToyotaDSUBypass", tr("DSU Bypass"), tr("<b>Force openpilot longitudinal control</b> on DSU-less Lexus/Toyota vehicles without a SmartDSU by reading ACC from the camera. Only enable this if your vehicle is wired for it."), ""},
